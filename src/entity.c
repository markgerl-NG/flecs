    ...
    bool * is_added)
{
    ...
    if (store && (sparse = store->sparse)) {
        return _ecs_sparse_get_or_create(sparse, 0, entity);
    }
    ...
    ecs_entity_t component)
{
    ...
    ecs_sparse_t *sparse;
    if (store && (sparse = store->sparse)) {
        _ecs_sparse_get_or_create(sparse, 0, entity);
    ...
    ecs_entity_t component)
{
    ...
    ecs_sparse_t *sparse;
    if (store && (sparse = store->sparse)) {
        ecs_sparse_remove(sparse, entity);
        ecs_defer_flush(world, stage);
        return;
    }
    ...
    ecs_entity_t component)
{
    ...
    ecs_sparse_t *sparse;
    if (store && (sparse = store->sparse)) {
        return _ecs_sparse_get_sparse(sparse, 0, entity);
    }
